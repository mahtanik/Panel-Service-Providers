                    ...
                    <div data-brackets-id="2086" class="x_panel">
                        <div data-brackets-id="2087" class="x_title">
                            <div data-brackets-id="2088" class="col-md-6" style="float: right">
                                ...
                                <br>
                                <h2 dir='rtl' data-brackets-id="2098" style="font-style: italic; float: right">  تغییرات اخیر و نمودار میله ای در هر سرویس   <small data-brackets-id="2099" style="font-style: italic"> شارژ ها و کاربران جدید برحسب زمان میزان  </small></h2>
